...
<body id="page-top">
  ...
  ?>
  <!--- Modal Update---->
  <div class="modal fade" id="tambahorang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="branchModalLabel">Form tambah penghuni kos</h5>
        ...
        <form action="" method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="KC">Nomor Kamar</label>
              <div class="form-label-group">
                <select class="form-control" name="KC" id="KC" required>
                  <option></option>
                  <?php
                  for ($i = 1; $i <= 10; $i++) { ?>
                    <option id="KC" value="<?= $i; ?>"><?= $i; ?></option>
                  <?php }; ?>
                </select>
              </div>
            </div>
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-primary" name="tamabh">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Data Penghuni Kos</h6>
            </div>
            <div class="card-body">
              <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#tambahorang" data-whatever="@mdo">
                  ...
                  <tbody>
                    ...
                    <?php foreach ($pesan as $brs) : ?>
                      <tr align="center">
                        ...
                        <td><?= $brs["nama"]; ?></td>
                        <td><?= $brs["jk"]; ?></td>
                        <td><?= $brs["tmpt_lhr"]; ?>, <?= $brs["tgl_lhr"]; ?></td>
                        <td><?= $brs["nowa"]; ?></td>
                        <td><?= $brs["kamar"]; ?></td>
                        <td>
                          <a title="Hapus" class='btn btn-danger' href="deleteAmor.php?id=<?= $brs["id"]; ?>" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fas fa-trash"></i>
                          </a>
                        </td>
                      </tr>
                      <?php $no++; ?>
